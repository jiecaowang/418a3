...
static bool bmp_byte_swap = !IS_BIG_ENDIAN;
    ...
    //
{
    ...
    for (j = 0; j < abs(height); j++)
    {
        for (i = 0; i < width; i++)
        {
            ...
            {
                std::cout << "\n";
                std::cout << "BMP_08_DATA_READ: Fatal error!\n";
                std::cout << "  Failed reading R for pixel (" << i << "," << j << ").\n";
                return error;
            }
        ...
        for (i = 0; i < padding; i++)
        {
            ...
            {
                std::cout << "\n";
                std::cout << "BMP_08_DATA_READ - Warning!\n";
                std::cout << "  Failed while reading padding character " << i << "\n";
                std::cout << "  of total " << padding << " characters\n";
                std::cout << "  at the end of line " << j << "\n";
                std::cout << "\n";
                std::cout << "  This is a minor error.\n";
                return false;
            }
        }
    }
...
bool bmp_24_data_read(std::ifstream &file_in, unsigned long int width, long int height,
    ...
    //
{
    ...
    for (j = 0; j < abs(height); j++)
    {
        for (i = 0; i < width; i++)
        {
            ...
            {
                std::cout << "\n";
                std::cout << "BMP_24_DATA_READ: Fatal error!\n";
                std::cout << "  Failed reading B for pixel (" << i << "," << j << ").\n";
                return error;
            }
            ...
            *indexb = (unsigned char)c;
            ...
            if (error)
            {
                std::cout << "\n";
                std::cout << "BMP_24_DATA_READ: Fatal error!\n";
                std::cout << "  Failed reading G for pixel (" << i << "," << j << ").\n";
                return error;
            }
        ...
        for (i = 0; i < padding; i++)
        {
            ...
            {
                std::cout << "\n";
                std::cout << "BMP_24_DATA_READ - Warning!\n";
                std::cout << "  Failed while reading padding character " << i << "\n";
                std::cout << "  of total " << padding << " characters\n";
                std::cout << "  at the end of line " << j << "\n";
                std::cout << "\n";
...
{
    std::cout << "\n";
    std::cout << "  Contents of BMP file header:\n";
    std::cout << "\n";
    std::cout << "    FILETYPE =     " << filetype << "\n";
    std::cout << "    FILESIZE =     " << filesize << "\n";
    std::cout << "    RESERVED1 =    " << reserved1 << "\n";
    std::cout << "    RESERVED2 =    " << reserved2 << "\n";
    std::cout << "    BITMAPOFFSET = " << bitmapoffset << "\n";
...
{
    std::cout << "\n";
    std::cout << "  Contents of BMP file bitmap header:\n";
    std::cout << "\n";
    std::cout << "    SIZE =            " << size << "\n";
    ...
    std::cout << "    SIZEOFBITMAP =    " << sizeofbitmap << "\n";
    std::cout << "    HORZRESOLUTION =  " << horzresolution << "\n";
    std::cout << "    VERTRESOLUTION =  " << vertresolution << "\n";
    std::cout << "    COLORSUSED =      " << colorsused << "\n";
    std::cout << "    COLORSIMPORTANT = " << colorsimportant << "\n";
    ...
    //
{
    ...
    std::cout << "\n";
    std::cout << "  Palette information from BMP file:\n";
    std::cout << "\n";

    if (colorsused < 1)
    {
        std::cout << "    There are NO colors defined for the palette.\n";
        return;
    }
    ...
    std::cout << "\n";
    std::cout << " Color    Blue   Green     Red   Trans\n";
    std::cout << "\n";
    ...
    //
{
    ...
    for (i = 0; i < colorsused; i++)
    {
        ...
        {
            std::cout << "\n";
            std::cout << "BMP_PALETTE_READ: Fatal error!\n";
            std::cout << "  Failed reading B for palette color " << i << ".\n";
            return error;
        }
        ...
        *indexb = (unsigned char)c;
        ...
        if (error)
        {
            std::cout << "\n";
            std::cout << "BMP_PALETTE_READ: Fatal error!\n";
            std::cout << "  Failed reading G for palette color " << i << ".\n";
            return error;
        }
        ...
        *indexg = (unsigned char)c;
        ...
        if (error)
        {
            std::cout << "\n";
            std::cout << "BMP_PALETTE_READ: Fatal error!\n";
            std::cout << "  Failed reading R for palette color " << i << ".\n";
            return error;
        }
        ...
        *indexr = (unsigned char)c;
        ...
        if (error)
        {
            std::cout << "\n";
            std::cout << "BMP_PALETTE_READ: Fatal error!\n";
            std::cout << "  Failed reading A for palette color " << i << ".\n";
            return error;
        }
...
# define VERBOSE false
    ...
    //  Open the input file.
    //
    file_in.open(file_in_name, std::ios::in | std::ios::binary);

    if (!file_in)
    {
        error = true;
        std::cout << "\n";
        std::cout << "BMP_PRINT_TEST - Fatal error!\n";
        std::cout << "  Could not open the input file.\n";
        return error;
    }
    std::cout << "\n";
    std::cout << "BMP_PRINT_TEST:\n";
    std::cout << "  Contents of BMP file \"" << file_in_name << "\"\n";
    //
    //  Read header 1.
    //
    ...
    if (error)
    {
        std::cout << "\n";
        std::cout << "BMP_PRINT_TEST: Fatal error!\n";
        std::cout << "  BMP_HEADER1_READ failed.\n";
        return error;
    }
    ...
    if (error)
    {
        std::cout << "\n";
        std::cout << "BMP_PRINT_TEST: Fatal error!\n";
        std::cout << "  BMP_HEADER2_READ failed.\n";
        return error;
    }
    ...
    if (error)
    {
        std::cout << "\n";
        std::cout << "BMP_PRINT_TEST: Fatal error!\n";
        std::cout << "  BMP_PALETTE_READ failed.\n";
        return error;
    }
    ...
    if (bitsperpixel == 8)
    {
        ...
        if (error)
        {
            std::cout << "\n";
            std::cout << "BMP_PRINT_TEST: Fatal error!\n";
            std::cout << "  BMP_08_DATA_READ failed.\n";
            return error;
        }
    ...
    else if (bitsperpixel == 24)
    {
        ...
        if (error)
        {
            std::cout << "\n";
            std::cout << "BMP_PRINT_TEST: Fatal error!\n";
            std::cout << "  BMP_24_DATA_READ failed.\n";
            return error;
        }
    }
    else
    {
        std::cout << "\n";
        std::cout << "BMP_PRINT_TEST: Fatal error!\n";
        std::cout << "  Unrecognized value of BITSPERPIXEL = " << bitsperpixel << "\n";
        return 1;
    }
    ...
    //
{
    ...
    if (filetype != magic)
    {
        std::cout << "\n";
        std::cout << "BMP_READ: Fatal error!\n";
        std::cout << "  The file's internal magic number is not \"BM\".\n";
        std::cout << "  with the numeric value " << magic << "\n";
        std::cout << "\n";
        std::cout << "  Instead, it is \""
            << (char)(filetype / 256)
            << (char)(filetype % 256)
            << "\".\n";
        std::cout << "  with the numeric value " << filetype << "\n";
        std::cout << "\n";
        std::cout << "  (Perhaps you need to reverse the byte swapping option!)\n";
        return 1;
    }
    //
    //  Read header 2.
    ...
    //
{
    ...
    //
    file_out.open(file_out_name, std::ios::out | std::ios::binary);
    ...
    {
        std::cout << "\n";
        std::cout << "BMP_08_WRITE - Fatal error!\n";
...
# define VERBOSE false
    ...
    {
        std::cout << "\n";
        std::cout << "BMP_08_WRITE_TEST - Fatal error!\n";
        std::cout << "  The test failed.\n";
        return error;
    }
    //
    ...
    //
{
    ...
    {
        std::cout << "\n";
        std::cout << "BMP_24_WRITE - Fatal error!\n";
        std::cout << "  Could not open the output file.\n";
        return error;
    }
    //
...
# define VERBOSE false
    ...
    {
        std::cout << "\n";
        std::cout << "BMP_24_WRITE_TEST - Fatal error!\n";
        std::cout << "  The test failed.\n";
        return error;
    }
    //
